        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Daftarkan kegiatan gereja baru</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" required
                                ...
                                <option value="ibadah" {{ old('type') == 'ibadah' ? 'selected' : '' }}>Ibadah</option>
                                <option value="retret" {{ old('type') == 'retret' ? 'selected' : '' }}>Retret</option>
                                <option value="kkr" {{ old('type') == 'kkr' ? 'selected' : '' }}>KKR</option>
                                <option value="bakti sosial" {{ old('type') == 'bakti sosial' ? 'selected' : '' }}>Bakti Sosial</option>
