        ...
        <div class="bg-primary text-primary-content">
            <div class="container mx-auto px-4 py-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold">Tambah Jemaat Baru</h1>
                        <p class="text-primary-content/80">Isi data jemaat baru</p>
                    </div>
                            ...
                            <div class="form-control">
                                ...
                                <select name="marital_status"
                                    ...
                                    <option value="cerai" {{ old('marital_status') == 'cerai' ? 'selected' : '' }}>
                                        Cerai</option>
                                    <option value="janda" {{ old('marital_status') == 'janda' ? 'selected' : '' }}>
                                        Janda</option>
                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="baptism_place" value="{{ old('baptism_place') }}"
                            ...
                            <div class="form-control">
                                ...
                                <input type="date" name="sidi_date" value="{{ old('sidi_date') }}"
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="sidi_place" value="{{ old('sidi_place') }}"
                            ...
                            <div class="form-control">
                                ...
                                <input type="date" name="marriage_date" value="{{ old('marriage_date') }}"
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="marriage_place" value="{{ old('marriage_place') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <select name="father_id"
                                    ...
                                    @foreach ($members as $member)
                                        <option value="{{ $member->id }}"
                                            {{ old('father_id') == $member->id ? 'selected' : '' }}>
                                            {{ $member->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-control">
                                ...
                                <select name="mother_id"
                                    ...
                                    @foreach ($members as $member)
                                        <option value="{{ $member->id }}"
                                            {{ old('mother_id') == $member->id ? 'selected' : '' }}>
                                            {{ $member->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-control">
                                ...
                                <select name="spouse_id"
                                    ...
                                    @foreach ($members as $member)
                                        <option value="{{ $member->id }}"
                                            {{ old('spouse_id') == $member->id ? 'selected' : '' }}>
                                            {{ $member->name }}
                                        </option>
                                    @endforeach
                                </select>
