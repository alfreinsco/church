    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Edit Penugasan Permission</h1>
                    <p class="text-gray-600 mt-1">Ubah permission untuk role {{ $role->name }}</p>
                </div>
        ...
        <!-- Form -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form action="{{ route('roles.assign-permissions', $role->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Pilih Permission <span class="text-red-500">*</span>
                    </label>
